function NavBar() {
  return (
    <div>
      <div className="row brightweb">
        <div className="col-md-2">
          <h3>
            <span> Bright</span> Web
          </h3>
        </div>
        <div className="col-md-1">
          <i className="far ICON fa-bars burgur"></i>
        </div>
        ...
        <div className="col-md-1">
          <h5>
            <strong>Jone Aly</strong>
          </h5>
          <h6>Admin</h6>
        </div>

        <i className="fa fa-angle-down selectWrapper " aria-hidden="true"></i>
      </div>
      {/* 
      <div className="row headbar">
        ...
        <img
          ...
          alt="Avatar"
          className="avatar"background-color: green;
        />
