      ...
      <div class="row">
          ...
          <div class="card  ">
            <div class="card-body">
              <div class="text-center p-3">
                ...
                <br />
                <span class="h2 no">$14.99</span>
              </div>
              <p class="card-text text-center">free space</p>
            </div>
            <ul class="items">
              <li class="list-item text-center">
                <h4>Cras justo odio</h4>
              </li>
              <li class="list-item text-center">Dapibus ac facilisis in</li>
              <li class="list-item text-center">Vestibulum at eros</li>
              <li class="list-item text-center">Dapibus ac facilisis in</li>
              <li class="list-item text-center">Vestibulum at eros</li>
              <li class="list-item text-center">Dapibus ac facilisis in</li>
              <li class="list-item text-center">Vestibulum at eros</li>
            ...
            <div class="card-body text-center">
              <button class="btn btn-outline-primary br">get started</button>
            </div>
          </div>
        </div>
        <div class=" col-md-4">
        ...
        <div class=" col-md-4">
          <div class="card">
            ...
            <div class="card-body text-center">
              <button class="btn btn-primary br ">get started</button>
            </div>
          </div>
        </div>
      </div>
